...
function Blogcard({title,content,date,id,author}:blogsProps){
    ...
    return(
        <Link to={`/blog/${id}`}>
            <div className='flex flex-col w-2/3 ml-32 py-5 border-l-1 border-b-2 border-gray-300'>
            ...
            <div>{title}</div>
            <div>{content.length>100?content.slice(0,70)+"...":content}</div>
            <div className='flex'>
                <Star/>
